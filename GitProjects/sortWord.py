...
# program: hello world and practice makes perfect and hello world again Then, the output should be: again and hello
# makes perfect practice world
a = input("Please enter some words: ")
items = [x for x in a.split(" ")]
print(list(sorted(set(items))))
